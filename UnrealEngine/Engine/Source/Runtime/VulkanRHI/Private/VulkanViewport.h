...
protected:
	...
	TArray<TRefCountPtr<FVulkanTexture>, TInlineAllocator<NumRequestedSwapchainImages*2>> BackBufferImages;
	TArray<TRefCountPtr<FVulkanSemaphore>, TInlineAllocator<NumRequestedSwapchainImages*2>> RenderingDoneSemaphores;
	TIndirectArray<FVulkanView, TInlineAllocator<NumRequestedSwapchainImages*2>> TextureViews;
