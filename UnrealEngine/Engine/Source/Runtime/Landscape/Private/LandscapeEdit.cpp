...
{
	checkf(LandscapeActor != nullptr, TEXT("ULandscapeInfo::DeleteLayer: Failed to delete landscape layer. Main LandscapeActor needs to be loaded and registered to the landscape info!"));
